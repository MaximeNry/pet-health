...
/**
 * App shell header: PetHealth wordmark on the left (links back to the
 * dashboard), the language switcher and a caller-provided action slot
 * (e.g. the account menu) on the right.
 */
